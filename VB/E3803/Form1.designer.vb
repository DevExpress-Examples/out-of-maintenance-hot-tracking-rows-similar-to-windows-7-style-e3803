...
'ORIGINAL LINE: this.gridView2.CustomDrawCell += new DevExpress.XtraGrid.Views.Base.RowCellCustomDrawEventHandler(this.myGridView1_CustomDrawCell);
'INSTANT VB NOTE: The following InitializeComponent event wireup was converted to a 'Handles' clause:
'ORIGINAL LINE: this.gridView2.MouseMove += new System.Windows.Forms.MouseEventHandler(this.myGridView1_MouseMove);
			' 
			' Form1
			' 
